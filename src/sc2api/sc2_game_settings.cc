...
ProcessSettings::ProcessSettings(bool in_realtime, int in_step_size,
                                 const std::string& in_process_path,
                                 const std::string& in_net_address,
                                 int in_timeout_ms, int in_port_start,
...
const char* kMapSentinel = "Ladder/Sentinel LE.SC2Map";
const char* kMapGoldenWall = "Ladder/Goldenwall.SC2Map";
